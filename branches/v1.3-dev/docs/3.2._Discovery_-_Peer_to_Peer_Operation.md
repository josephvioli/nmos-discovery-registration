...
The following pre-requisites are optional aspects of the [Node API](../html-APIs/NodeAPI.html) implementation which must be in place to permit peer-to-peer discovery.

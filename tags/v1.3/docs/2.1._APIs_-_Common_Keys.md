...
Note: From v1.3 onwards, permitted transport types are not versioned and are instead defined via the [NMOS Parameter Registers](https://amwa-tv.github.io/nmos-parameter-registers). Prior to v1.3, the following table applies.
...
Note: From v1.3 onwards, permitted device types are not versioned and are instead defined via the [NMOS Parameter Registers](https://amwa-tv.github.io/nmos-parameter-registers). Prior to v1.3, the following table applies.
